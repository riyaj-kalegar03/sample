...
const AddContent = () => {
  ...
  const handleSubmit = (e) => {
    ...
    let apiUrl = "";
    if (contentType === "book") {
      apiUrl = "http://localhost:4000/book/add";
    } else if (contentType === "news") {
      apiUrl = "http://localhost:4000/news/add";
    } else if (contentType === "service") {
      apiUrl = "http://localhost:4000/service";
    }
    ...
    fetch(apiUrl, {
      ...
      .then((data) => {
        if (data.success) {
          ...
          history.push("/AdminDashboard"); // Redirect to dashboard or another page
        } else {
